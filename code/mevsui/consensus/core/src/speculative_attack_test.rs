...
//! Speculative Attack Test for MEVSUI with 13 Nodes
//!
//! This test measures the Attack Success Rate (ASR) of the speculative attack
//! where attackers generate multiple block candidates and select the one with
...
async fn test_speculative_attack_asr_13_nodes() {
    ...
    println!("  Bullshark Baseline: TBD");
...
fn calculate_asr(commits: &[CommittedSubDag]) -> f64 {
    ...
    // For speculative attack: attackers generate multiple candidates and select best digest
