...
## 🎯 Fissure Attack Implementation

**This repository includes a complete implementation of the Fissure Attack on Narwhal-Tusk**, achieving **85.5% Attack Success Rate (ASR)** on a real 4-node distributed network.

### Quick Attack Execution
```bash
# Run the automated fissure attack
./automated_fissure_attack.sh

```

### Attack Results
- **ASR**: 85.5% (within 2% of paper's 87.31% target)
- **Network**: 4 nodes (1 attacker, 1-2 victims, 1-2 honest)
