...
#[cfg(test)]
const MAP_SIZE: u64 = 0x100_000; // 1 MB for tests (increased from 64KB to prevent WAL overflow during attacks)
#[cfg(test)]
const MAP_MASK: u64 = !0xfffff; // Updated mask to match new MAP_SIZE
